...
** a
Pmf'en er geometrisk fordelt, da vi tæller antal forsøg indtil succes [table 1. Essentials of PROBABILITY THEORY]. Dvs. X antager værdierne $Support\{ 1,2... \infty \}$, og kan derfor opskrive vores pmf: $$p(x)=\frac{1}{2^x}$$
