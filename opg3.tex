...
\section*{1}
\label{sec:org23598a8}

\subsection*{a}
\label{sec:org7cdb498}
...
\section*{2}
\label{sec:orgae33286}
\subsection*{a}
\label{sec:org42a07c2}
\begin{center}
\begin{tabular}{lrrl}
p(x, y) & y = −1 & y = 1 & y = 3\\
x = −1 & 0.1 & 0.1 & z\\
