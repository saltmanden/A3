...
\section*{1}
\label{sec:org0aeef0e}

\subsection*{a}
\label{sec:orgda139c4}
...
\section*{2}
\label{sec:orgdd40a13}
\subsection*{a}
\label{sec:orge59f13e}
\begin{center}
\begin{tabular}{lrrl}
p(x, y) & y = −1 & y = 1 & y = 3\\
x = −1 & 0.1 & 0.1 & z\\
